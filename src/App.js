    ...
    <div className={`logo-container ${animate ? 'animate' : ''}`}>
      ...
      <div className={`projects ${showProjects ? 'show-projects' : ''}`}>
          ...
          <a href="https://stat.mrl.dev/" target="_blank" rel="noopener noreferrer">
            ...
            </a> probability calculators <a href="https://github.com/SebastianMorel/statziki2" target="_blank">[code]</a></span>
            <br></br>
            ...
            </a> ai chart maker <a href="https://github.com/SebastianMorel/plotandpray" target="_blank">[code]</a></span>
            <br></br>
